...
scope: core/notification/ 的实况通知抽象层，覆盖统一门面、三平台 backend、设备能力检测、课程倒计时调度，以及与 RunTrackingService / HomeViewModel 的消费关系
summary: notification 以 LiveActivityNotifier 为统一门面，根据设备能力自动选择 Flyme / Android16 / Normal backend，业务层只构造 LiveActivityRequest 不接触平台私有实现
status: current
last_reviewed: 2026-05-24
tags: [notification, flyme, android16, live-activity, running, schedule]
